      ...
      * -------------------------------------------------------------- *
       ...
       01  WS-AREAS-AUSAR.
           05 WS-REG-EMPLEADOS.
              ...
              10 WS-SALARIO-EMP   PIC 9(07)V99 VALUE ZEROS.
           05 WS-LEIDOSS-EMP      PIC 9(05)    VALUE ZEROS.
       ...
       01  WS-SUB-TITULO-1.
           05 FILLER              PIC X(04)    VALUE SPACES.                                                                                                                          CC
       ...
       050-FINAL.
           ...
           MOVE WS-IMPRESOS       TO WS-TOT-IMPRSOS
           WRITE REG-REPORTE FROM WS-DETALLE-IMPRESOS                                                                                                                                  R
           MOVE WS-TOT-SALARIOS   TO WS-TOT-SALARIO2
           WRITE REG-REPORTE FROM WS-DETALLE-SALARIOS                                                                                                                                  R
           CLOSE EMPLEADOS REPORTE.                                                                                                                                                    R
       050-FIN.  EXIT.
